...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <custom>true</custom>
    <description>Funcionalidade total para o(s) seguinte(s) objeto(s): Oportunidades, Tarefas, Contas, Atividades; (2) ter funcionalidade somente leitura para o(s) seguinte(s) objeto(s): Produtos e Lista de Preços, Cotações, Previsão, Ativos, Casos</description>
    <fieldPermissions>
