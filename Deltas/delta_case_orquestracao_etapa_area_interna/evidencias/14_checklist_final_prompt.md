...
|---|---|---|---|
| 1 | Objetivo do pacote atendido | ✅ | addParticipation → 'Aguardando Área Interna'; closeParticipation → 'Preparando Retorno ao Cliente' ou manter; guard terminal; Standard excluído |
...
| 9 | Standard APs não afetam EtapaAtendimento__c | ✅ | Filtro BloqueiaFechamentoCaso__c=true exclui Standard; testado em #5 |
| 10 | Guard para Case terminal implementado | ✅ | addParticipation e closeParticipation guardam 'conclu' e 'cancel' |
| 11 | Testes obrigatórios executados | ✅ | 6 novos + 12 de regressão = 18 testes; 0 falhas |
| 12 | package.xml mínimo e sem wildcard | ✅ | Apenas ApexClass:AreaParticipanteService + ApexClass:AreaParticipanteServiceTest |
| 13 | UTF-8 sem BOM | ✅ | evidência 11 |
| 14 | Sem mojibake | ✅ | evidência 12 |
| 15 | Prompt relido antes da finalização | ✅ | Todos os itens verificados |

## Pendências antes de declarar pronto

- [x] Dry-run executado — Deploy ID `0Afbe00000AA2ysCAD`, Succeeded, 18/18 testes, 85% cobertura
