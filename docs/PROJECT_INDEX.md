...
|---|---|---|---|
| caseAreaParticipantePanel | force-app/main/default/lwc/caseAreaParticipantePanel/ | AreaParticipanteController (getPanelData, addParticipation, closeParticipation) | Painel de Áreas Participantes na Record Page do Case: lista, aciona e conclui participações; exibe dados SLA; não calcula SLA no front. |
